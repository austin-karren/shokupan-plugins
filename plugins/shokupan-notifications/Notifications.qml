...
BarWidget {
  id: root
  moduleName: "shokupan.notifications"
  ...
  readonly property int pendingCount: notificationService && notificationService.pendingModel ? notificationService.pendingModel.count : 0
  readonly property int pastCount: notificationService && notificationService.pastModel ? notificationService.pastModel.count : 0
