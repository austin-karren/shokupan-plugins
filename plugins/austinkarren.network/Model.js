...
function connectionIcon(kind, signalStrength) {
  ...
  // SHOKUPAN: wired shows a globe (U+F059F), not an RJ45 port (upstream
  // SHOKUPAN: hardcodes U+F0200) — ADR-0029 "Wired shows a globe, not a port".
  if (kind === "ethernet") return "\u{f059f}" // SHOKUPAN: was "\u{f0200}"
  return "󰤮"
}
